                ...
                <nav class="navbar navbar-expand-xl bg-warning   py-3 py-lg-0 px-0  ">
                    ...
                    <div class="collapse navbar-collapse  justify-content-center" id="navbarCollapse" style="text-align: center;">
                        <div class="navbar-nav mr-auto py-0 mt-3">
                            ...
                            <a href="cart.php" class="nav-item na nav-link " style="color: gray;">Cart</a>
                            <a href="checkout.php" class="nav-item na nav-link" style="color: gray;">Checkout</a>
                            <a href="contact.php" class="nav-item na nav-link border border-dark " style="color: gray;">Contact</a>
    ...
    <div class="container-fluid ">
        ...
        <div class="row px-xl-5 " >
            <div class="col-lg-7 mb-5" >
                <div class="contact-form bg-light shadow p-30" style="background-color: black;">
                    <div id="success"></div>
            ...
            <div class="col-lg-5 mb-5">
                <div class="bg-light shadow p-30 mb-30">
                    <iframe style="width: 100%; height: 234px;"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3001156.4288297426!2d-78.01371936852176!3d42.72876761954724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4ccc4bf0f123a5a9%3A0xddcfc6c1de189567!2sNew%20York%2C%20USA!5e0!3m2!1sen!2sbd!4v1603794290143!5m2!1sen!2sbd"
                    frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
                <div class="bg-light shadow-lg p-30 mb-3">
