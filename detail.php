...
<head>
    <meta charset="utf-8">
    <title>INGco Tools - Online Shop</title>
...
<br><br>
                ...
                <nav class="navbar navbar-expand-lg bg-warning navbar-light     py-3 py-lg-0 px-0  ">
                    ...
                    <div class="collapse navbar-collapse   justify-content-center" id="navbarCollapse" style="text-align: center;">
                        <div class="navbar-nav mr-auto py-0 mt-3">
                            ...
                            <a href="index.php" class="nav-item na nav-link   " style="color:grey">Home</a>
                            <a href="detail.php" class="nav-item na  nav-link border border-dark active " style="color:grey">Shop Detail</a>
                            <a href="cart.php" class="nav-item na  nav-link " style="color:grey">Cart</a>
                            <a href="checkout.php" class="nav-item  na nav-link" style="color:grey">Checkout</a>
    ...
    <!-- Navbar End -->    <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js'></script>
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="img/ingco mauritiusfull range of ingco product.png" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <form>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label class="custom-control-label" for="size-4">Large</label>
                            </div>
                    ...
                    <div class="d-flex mb-4">
                        ...
                        <form>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label class="custom-control-label" for="color-2">yellow</label>
                            </div>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3 " style="width: 80px;">
                            <div class="input-group-btn">
                              
                                
                            </div>
                            <input type="number" class="form-control bg-warning border-0 text-center" value="1">
                            <div class="input-group-btn">
